...
public class ExecutionDetails extends  JDialog {
    ...
    private OrdStatus fixOrdStatus = null;
...
//return details;
    ...
    public char getOrdStatus() {
        if (fixOrdStatus != null) {
            return fixOrdStatus.getValue();
        }
    ...
    public void setFixOrdStatus(OrdStatus fixOrdStatus) {
